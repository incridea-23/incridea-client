                    ...
                    <div className='md:mx-36 mx-5 text-white text-center flex flex-col gap-2 bodyFont'>
                        {false && sortedLeaderboard.map((user,i) => (
                            ...
                            className={`${getColor(i+1)} shadow-2xl rounded-lg flex flex-row items-center justify-center h-16 `}>
                                ...
                                <h1 className="basis-1/4 flex justify-center items-center text-center text-sm md:text-xl font-semibold mx-2">{idToPid(user.userId)}</h1>
                                <h1 className="basis-1/4 flex justify-center text-center items-center text-sm md:text-xl font-semibold capitalize">{user.name}</h1>
