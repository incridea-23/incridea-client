...
const Refund: NextPage = () => {
  return (
    <div className="relative min-h-screen overflow-y-hidden w-full overflow-x-hidden bg-gradient-to-bl  from-[#41acc9]  via-[#075985] to-[#2d6aa6] text-gray-100 p-5 sm:p-10">
      <Image
      ...
      <div className="mt-[3em]">
        ...
        <p className="mt-2">
          Our payment process is designed to be easy and convenient for you. We
          offer multiple payment options, including credit/debit cards, net
        ...
        <p className="mt-2">
          ...
          transactions are secure and protected by industry-standard encryption.
          You can be confident that your payment information is safe when you
          use our website for registration.
        </p>
      ...
      <div
        className={`flex w-full -translate-x-10 translate-y-[5.9em] opacity-75`}
      >
        <Image
