    ...
    <div className="overflow-x-hidden overflow-y-auto bg-gradient-to-bl  from-[#41acc9]  via-[#075985] to-[#2d6aa6] text-gray-100 p-5 sm:p-10">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <ul className="mt-2 list-disc pl-4">
          ...
          <li>
            Participants are responsible for ensuring the accuracy and validity
            of their PID and other personal information. Failure to provide a
            valid PID will result in the participant being ineligible to
        ...
        <ol className="mt-2 list-decimal pl-4">
          <li>
            {' '}
            NMAM Institute of Technology students who pay ₹200 will have access
          ...
          <li>
            ...
            core event they were invited to. If the invite-only participant is a
