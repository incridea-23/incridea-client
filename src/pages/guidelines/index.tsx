  ...
  return (
    <div className="w-full overflow-x-hidden overflow-y-auto bg-gradient-to-bl  from-[#41acc9]  via-[#075985] to-[#2d6aa6] text-gray-100 p-5 sm:p-10">
      ...
      <p className="mt-2">
        ...
        festival is open to all students; however, some events are exclusive to
        select colleges in the country. This article outlines the guidelines and
        regulations that participants need to follow while participating in the
        festival.
      </p>
      ...
      <ul className="mt-2 list-disc pl-4">
        <li>
          Some events such as Battle of the Bands, Couture, Vibe, Stomp That,
          and Navarasa are open to all colleges in the country.
        </li>
        <li>
          To register for these events, participants must receive an invite from
          their college.
        </li>
        <li>
      ...
      <ul className="mt-2 list-disc pl-4">
        <li>
          All participants must present a valid PID (Participant Identification)
          during registration.
        </li>
        <li>
          The PID provided must belong to the participant registering for the
          event, and the organizers reserve the right to verify its
          authenticity.
        </li>
        <li>
          Any participant found to have provided false or misleading information
          will be disqualified.
        </li>
        <li>
          Participants are responsible for ensuring the accuracy and validity of
          their PID and other personal information. Failure to provide a valid
          PID will result in the participant being ineligible to participate in
          the event.
        </li>
      </ul>
      ...
      <p className="mt-2">
        The championship will be awarded based on the sum of all points scored
        by a college.
      </p>
      <h2 className="text-2xl my-6">Rules and Regulations:</h2>
      <ul className="mt-2 list-disc pl-4">
        <li>
          Participants must follow all the rules and regulations set forth by
          the college.
        </li>
        <li>
      ...
      <ul className="mt-2 list-disc pl-4">
        <li>
          The consumption of alcoholic drinks, use of hallucinogenic drugs or
          other illegal substances on the campus premises is strictly
          prohibited.
        </li>
        <li>
      ...
      <ul className="mt-2 list-disc pl-4">
        ...
        <li>
          NMAMIT/NITTE University is not responsible for any loss or damage to
      ...
      <ul className="mt-2 list-disc pl-4">
        <li>
          Entry for events and pronites will be via the Incridea app or website.
        </li>
        <li>
          Attendees must present their college IDs along with a valid
          government-issued ID proof (Aadhaar, driving license, Voter ID, etc.)
          to access the event and pronites.
        </li>
      </ul>
      <h2 className="text-2xl my-6">Participant Categories:</h2>
      <p className="mt-2">
        Four different categories of participants are permitted to participate:
      </p>
      <ol className="mt-2 list-decimal pl-4">
        <li>
          {" "}
          NMAM Institute of Technology students who pay ₹200 will have access to
        ...
        <li>
          Non-engineering college and Nitte sister college students who pay ₹300
          will have access only to Core Events and pronites.
        </li>
        <li>
          {" "}
          Invite-only participants who pay ₹150 will have access to the one core
          event they were invited to. If the invite-only participant is a
          college student and wants to attend pronite, they will have to
      ...
      <p className="mt-2">
        ...
        violating the rules may be immediately expelled from the campus. Their
        registration for all events may be cancelled, and they will be penalized
