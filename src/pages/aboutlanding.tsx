...
import Banner from "../../public/assets/About/Banner";
import Reveal from "../../public/assets/About/reveal";
...
const AboutLanding = () => {
    ...
    gsap.fromTo(aboutcontainer.current,
        { x: -200 },
        {
            duration: 3,
            x: 200,
    ...
    gsap.fromTo(aboutcontaine.current,
        { x: -200 },
        {
            duration: 3,
            x: 200,
    ...
    return (
        <section className="flex flex-col gap-2 justify-center items-center  bg-[#6a5fd7]">
            <div className="flex flex-col h-screen min-h-min justify-around gap-1 items-center">
                ...
                <div className="mx-4 sm:mx-8 lg:mx-32 flex flex-col md:flex-row gap-10 justify-center items-center max-w-7xl">
                    ...
                    <div className="w-full md:w-2/3 flex flex-col text-center md:text-left gap-7 md:gap-5">
                        <span className="">
                            <h2 className="font-VikingHell text-3xl sm:text-4xl md:text-5xl 2xl:text-6xl text-secondary-100" ref={aboutcontainer}>
            ...
            <div className="flex flex-col h-screen min-h-min justify-around gap-8 items-center animate-fadeIn">
                ...
                <div className="mx-4 sm:mx-8 lg:mx-32 flex flex-col md:flex-row gap-10 justify-center items-center max-w-7xl">
                    ...
                    <div className="w-full md:w-2/3 flex flex-col text-center md:text-left gap-7 md:gap-5 mb-12">
                        <span className="">
                            <h2 className="font-VikingHell text-3xl sm:text-4xl md:text-5xl 2xl:text-6xl  text-secondary-100" ref={aboutcontaine}>
