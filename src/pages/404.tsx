  ...
  return (
    <div className="flex flex-col justify-center items-center bg-gradient-to-bl  from-[#41acc9]  via-[#075985] to-[#2d6aa6]">
      ...
      <div className="flex flex-col justify-center items-center mb-10">
        <h1
          className={`titleFont text-xl text-white transition-colors duration-300 flex justify-center items-center text-center mx-2`}
        >
          {titleText}
        </h1>
        <h1
          className={`titleFont text-lg text-white transition-colors duration-300 flex justify-center items-center text-center mx-2`}
        >
          {bodyText}{' '}
        </h1>
        <Link href={'/'} as="/">
