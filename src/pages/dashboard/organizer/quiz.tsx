  ...
  return (
    <Dashboard>
      <div className='flex flex-col'>
        <input className='text-2xl font-medium mt-4 w-60 rounded-2xl bg-gray-900/80 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-30 outline-none p-2 px-4' placeholder='Enter  quiz title' />
        <div className='flex flex-row py-8'>
          ...
          <input className='w-[1000px] h-24 rounded-3xl px-4 mt-4 bg-slate-600 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-20 outline-none'></input>
