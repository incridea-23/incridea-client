    ...
    return (
      <div className="relative min-h-screen w-full overflow-x-hidden overflow-y-auto bg-gradient-to-br from-[#044b8b]  to-[#020024] text-gray-100 p-5 sm:p-10">
        ...
        <div className='mt-8'>
          ...
          <h2 className='text-2xl mt-4'>Information Collection, Use, and Sharing</h2>
          <p className='mt-2'>
            ...
            other than as necessary to fulfil your request, e.g: To issue your
          ...
          <h2 className='text-2xl mt-4'>Your Access to and Control Over Information</h2>
          <p className='mt-2'>
          ...
          <p className='mt-2'>
            ...
            for a lock icon in the address bar and looking for &quot;https&quot;
            at the beginning of the address of the Web page. While we use
          ...
          <p className='mt-2'>
            ...
            . To buy from us, you must provide contact information (like name
            and date of birth) and financial information (like credit card
            number, expiration date). This information is used for billing
            purposes and to fullfil your orders. If we have trouble processing
            an order, we&apos;ll use this information to contact you. The
            contact information collected while ordering from us will be only
            used to send order related details and information and wont be used
            for anything else.
          </p>
          ...
          <p className='mt-2'>
            ...
            other sites. While we have read and verified the linked websites
            privacy policy to comply with our standards, we encourage our users
            to be aware when they leave our site and to read the privacy
