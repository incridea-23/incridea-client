    ...
    return (
        <>
            <div className="w-full min-h-screen overflow-x-hidden overflow-y-auto text-gray-100">
                ...
                {/* Header Part */}
                <div className="h-screen w-full relative flex bg-center bg-[url('/assets/png/pronite_bg.png')] bg-cover">
                    <motion.div
                    animate={{ y: [20, 0], opacity: [0, 1], repeatCount: 1 }}
                    transition={{ duration: 3 }}
                    className="absolute z-10 flex flex-col justify-center w-full px-2 py-10 top-1/2 md:py-2 md:px-8 bg-black/50"
                ...
                <div className="h-screen w-full absolute top-0 left-0 flex bg-center bg-primary-800/40"></div>
                {/* <div className="bg-gradient-to-t from-[#2305c7]  to-[#00c4ff] pt-12 pb-12"> */}
                <div className="bg-[url('/assets/png/uw.png')] bg-cover pt-12 pb-12 water">
                    {
...
function ArtistsCard(props: {
    ...
    return(
        <div className={`${props.reverse?" md:flex-row-reverse" :"" } flex flex-col items-center justify-center p-3 mx-auto text-base ease-in-out border-2 md:gap-0 md:max-w-sm md:px-10 lg:max-w-md xl:max-w-xl md:flex-row border-slate-500/50 transform-color ease-liner md:p-5 rounded-xl  md:border-none md:bg-none mb-6 `}>
            ...
            <motion.div
                    ...
                    transition={{ duration: 3 }}>
                <div className="flex-2 p-6 m-4 max-w-fit neonBorder bg-[#21f2f55a]">
                    <h1 className="text-4xl text-center sm:text-6xl text-secondary-900 neonText">{props.artistname}</h1>
                    <p className="text-2xl text-center text-primary-900">{props.date}<br/>
                    @ {props.time}</p>
                </div>
            </motion.div>
        </div>
