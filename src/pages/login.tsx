...
const SignIn: NextPage = () => {
    ...
    return (
        // TODO: font usage
        <div
            className={`${customFont.className} min-h-screen pt-20 md:pt-0 overflow-x-hidden min-w-screen bg-[#f3e9d1]`}>
            <div
                ...
                {/* FIXME: Desktop last year left side */}
                ...
                <div className="flex justify-center items-start">
                    <div className="">the portal placeholder</div>
                </div>
                ...
                <div
                    ...
                    <div className="md:max-w-md flex md:py-10 flex-col h-full min-h-screen">
                        <div className="p-6 md:py-10 grow">
                            {/* HACKME: card */}
                            {/* card  */}
                            <div className="bg-red-400 min-h-[600px] flex items-center justify-center p-3">
                                {/* <SignInForm
                ...
                {/* FIXME: Desktop last year right side */}
