    ...
    >
      <div className="grid  grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="mx-auto">
          ...
          <hr />
          <div className={`text-lg flex justify-center space-x-2 items-center ${titleFont.className}`}>
            <a
              href="#"
              className="px-5 flex items-center gap-2 py-2 text-xl font-semibold text-center text-white transition duration-300 rounded-b-lg bg-white/30 hover:bg-white/40"
            >
