...
const Loader: FC = () => {
    ...
    return (
        <>{
            (isLoading) ? (
                <div className={`h-screen w-screen bg-gradient-to-b from-primary-200 to-primary-400`}>
                    <div className={`${styles.box} bg-transparent ${isLoading ? "z-[9000]" : ""}`}>
                        ...
                        <div className="h-screen w-full flex flex-col justify-center items-center">
                            <Image className=" animate-pulse w-auto h-auto" src={'/assets/loader/dodLogo.png'} alt="logo" height={250} width={250} />
                        </div>
