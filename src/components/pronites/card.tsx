  ...
  return (
    <>
      <div
        ...
        className="absolute text-white bottom-6 right-6 md:bottom-10 md:right-10 z-50 pointer-events-none rounded-[14px] w-[210px] md:w-[300px]"
      >
        <Image
          src={artist.imageSrc}
          alt={artist.name}
        ...
        <div
          ...
          } h-full w-full opacity-70 -z-50 rounded-[14px]`}
        ></div>
