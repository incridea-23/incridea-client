    ...
    <nav className="fixed top-0 z-10 bg-white backdrop-filter backdrop-blur-sm bg-opacity-10 border-b border-gray-200 w-full">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-center h-16">
          <div className="flex flex-1 space-x-4 text-gray-900">
            {links.map((link) => (
              <Link
          ...
          <Link
            className="bg-white w-fit  bg-opacity-30 p-1 rounded-full backdrop-filter backdrop-blur-lg"
            href="/">
            <Image src="/logo.png" alt="Logo" width={50} height={50} priority />
          </Link>
          <div className="flex flex-1  w-full justify-end space-x-4">
