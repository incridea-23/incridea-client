...
const elements: string[] = ['trophy.png', 'dice.png', 'sword.png', 'witchHat.png', 'pawn.png', 'pacman.png', 'sheild.png', 'bomb.png', 'coin.png', 'potion.png','bowArrow.png'];
    ...
    return (
        <>
            <div className="flex justify-center items-center w-full h-[50px] md:h-16 xl:h-20 mb-2">
                ...
                <div
                    className={`portal relative bg-gray-600 h-[95vw] w-6 sm:h-[580px] sm:w-7 md:h-[700px] md:w-9 lg:h-[940px] xl:h-[1200px] rounded-[50%] ${isTop ? "rotate-90" : "-rotate-90"
