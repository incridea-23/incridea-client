...
const ProfileInfo: FC<{
  ...
  return (
    <section className="text-white h-full flex justify-center items-center">
      {/* <div className="flex mb-4 items-center justify-center px-5">
        <a
          className={`titleFont text-2xl lg:text-4xl font-bold text-center pr-2`}
        >
 ...
 <div className='flex flex-col h-full px-2 lg:px-0 lg:pt-0 pt-20 justify-center items-start'>
  <div className='flex flex-row items-center'>
  ...
  <div className='flex lg:flex-row justify-around items-center w-full  mt-3'>
      {/* //leaderboard and level div */}
  ...
  <div className='flex flex-row text-center text-white justify-between items-center w-full px-5 mt-5'>
