...
import { CompletedEventsDocument, CompletedEventsQuery, Query, QueryCompletedEventsSuccess } from "@/src/generated/generated";
  ...
  return (
    <>
      <div className="mt-5 flex gap-1 md:gap-0.5 flex-col justify-center basis-2/3">
        ...
        <SearchBox placeholder="Search by event name" className="my-2 ml-2" value={query} onChange={(e) => {
        ...
        <div className="md:max-h-80 max-h-80 md:h-[300px] overflow-y-auto text-center w-full">
          {eventsData?.completedEvents.__typename === "QueryCompletedEventsSuccess"
            ? eventsData.completedEvents.data.map((event, i) => (
