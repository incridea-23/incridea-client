    ...
    return (<>
        ...
        <div className="flex gap-1 flex-row md:flex-row md:justify-between ">
            ...
            <div className="mt-5 flex gap-1 md:gap-0.5 flex-col basis-3/5">
                    ...
                    <div className="hidden md:flex ml-2 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg bg-clip-padding rounded-t-lg p-1 items-center justify-between gap-2.5 text-lg font-bold">
