...
const GalleryPeek: FC = () => {
  ...
  return (
    <section className="relative">
      <div className="w-[500%] lg:w-[200%] flex gap-1 lg:gap-5 py-2 lg:py-5 items-center absolute left-0 animate-scroll border border-t-2 border-b-2 border-gray-400 backdrop-filter">
        {images.map((i) => {
          return (
