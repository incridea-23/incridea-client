...
export type GetQuizByEventQuery = { __typename?: 'Query', getQuizByEvent: { __typename: 'Error', message: string } | { __typename: 'QueryGetQuizByEventSuccess', data: Array<{ __typename?: 'Quiz', name: string, questions: Array<{ __typename?: 'Question', image?: string | null, negativePoint: number, point: number, question: string, questionType: string, options: Array<{ __typename?: 'Options', id: string, isAnswer: boolean, value: string }> }> }> } };
