...
export type JudgeGetTeamsByRoundSubscription = { __typename?: 'Subscription', judgeGetTeamsByRound: Array<{ __typename?: 'Team', id: string, name: string, roundNo: number, leaderId?: number | null }> };
