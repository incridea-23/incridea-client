...
export type ConfirmTeamMutation = { __typename?: 'Mutation', confirmTeam: { __typename: 'Error', message: string } | { __typename: 'MutationConfirmTeamSuccess', data: { __typename?: 'Team', confirmed: boolean, id: string, name: string, event: { __typename?: 'Event', name: string }, members: Array<{ __typename?: 'TeamMember', user: { __typename?: 'User', name: string, email: string } }> } } };
