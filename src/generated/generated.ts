...
export type PublishedEventsQuery = { __typename?: 'Query', publishedEvents: Array<{ __typename?: 'Event', id: string, name: string, image?: string | null, venue?: string | null, fees: number, maxTeamSize: number, maxTeams?: number | null, minTeamSize: number, eventType: string, branch: { __typename?: 'Branch', name: string, id: string } }> };
