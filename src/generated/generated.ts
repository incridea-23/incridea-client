...
export type MyQueryQuery = { __typename?: 'Query', myTeam: { __typename: 'Error', message: string } | { __typename: 'QueryMyTeamSuccess', data: { __typename?: 'Team', attended: boolean, confirmed: boolean, id: string, leaderId?: number | null, name: string, members: Array<{ __typename?: 'TeamMember', user: { __typename?: 'User', email: string, id: string, phoneNumber?: string | null, name: string, college?: { __typename?: 'College', name: string } | null } }> } } };
