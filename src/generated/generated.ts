...
export type GetQuizByRoundEventQuery = { __typename?: 'Query', getQuizByRoundEvent: { __typename: 'Error', message: string } | { __typename: 'QueryGetQuizByRoundEventSuccess', data: Array<{ __typename?: 'Quiz', description?: string | null, password?: string | null, endTime: any, eventId: string, id: string, name: string }> } };
