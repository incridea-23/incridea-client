...
export type RegisterdEventsQuery = { __typename?: 'Query', registeredEvents: { __typename: 'Error', message: string } | { __typename: 'QueryRegisteredEventsSuccess', data: Array<{ __typename?: 'Event', id: string, image?: string | null, name: string, venue?: string | null, rounds: Array<{ __typename?: 'Round', date?: any | null, roundNo: number }>, teams: Array<{ __typename?: 'Team', confirmed: boolean, name: string, members: Array<{ __typename?: 'TeamMember', user: { __typename?: 'User', id: string, name: string } }> }> }> } };
