...
export type MyMutationMutation = { __typename?: 'Mutation', removeBranchRep: { __typename: 'Error', message: string } | { __typename: 'MutationRemoveBranchRepSuccess', data: string } };
