...
export type PublishedEventsQuery = { __typename?: 'Query', publishedEvents: Array<{ __typename?: 'Event', id: string, name: string, image?: string | null, venue?: string | null, fees: number, maxTeamSize: number, maxTeams?: number | null, minTeamSize: number, category: string, eventType: string, branch: { __typename?: 'Branch', name: string, id: string }, rounds: Array<{ __typename?: 'Round', date?: any | null, roundNo: number, completed: boolean }> }> };

export type RegisterdEventsQueryVariables = Exact<{ [key: string]: never; }>;


export type RegisterdEventsQuery = { __typename?: 'Query', registeredEvents: { __typename: 'Error', message: string } | { __typename: 'QueryRegisteredEventsSuccess', data: Array<{ __typename?: 'Event', id: string, image?: string | null, name: string, venue?: string | null, category: string, rounds: Array<{ __typename?: 'Round', date?: any | null, roundNo: number }>, teams: Array<{ __typename?: 'Team', id: string, leaderId?: number | null, confirmed: boolean, name: string, members: Array<{ __typename?: 'TeamMember', user: { __typename?: 'User', id: string, name: string } }>, event: { __typename?: 'Event', name: string, id: string, maxTeamSize: number, fees: number, eventType: string } }> }> } };
